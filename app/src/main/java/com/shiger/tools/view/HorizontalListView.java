...
//        setSelectionFromTop(position, 0);
    ...
    public synchronized void scrollToPosion(int position) {
//        View child = getChildAt(position);
//        int childWidth = child.getMeasuredWidth();//child width

        Log.d(TAG, "mCurrentX-"+mCurrentX);
        Log.w(TAG, "mNextX-"+mNextX);
        mScroller.startScroll(mCurrentX, 0, position * 120, 0);
        requestLayout();
    }
